...
**v1.16.0 — sudah di-release & di-push** (`main` = `origin/main` = tag `v1.16.0`). Terbit di npm publik
sebagai `@cahyo-dimas/freeday`. **v1.16.0 = rilis pertama library komponen Blazor native** (RCL
