...
**v1.3.0 — sudah di-release & di-push** (`main` = `origin/main` = tag `v1.3.0`, tree bersih).
Jalur rilis: … → v1.2.1 (input-group fix) → v1.2.2 (brand link-safe + indikator teal→primary) → v1.3.0 (accent teal → biru Microsoft Azure).
...
- **Pakai di project:** `npm i github:cahyo-dimas/freeday-ui-kit#v1.3.0` — panduan di
