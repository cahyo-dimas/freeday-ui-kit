...
**v1.11.0 — sudah di-release & di-push** (`main` = `origin/main` = tag `v1.11.0`). Terbit di npm
publik sebagai `@cahyo-dimas/freeday`. (1.11.0 = follow-up notes #31–#33, aditif/korektif: **#31**
