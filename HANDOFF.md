...
**v1.15.0 — sudah di-release & di-push** (`main` = `origin/main` = tag `v1.15.0`). Terbit di npm publik
sebagai `@cahyo-dimas/freeday`. (1.15.0 = deklarasi tipe untuk **semua** export, aditif/MINOR #40: dulu hanya
