...
**v1.2.0 — sudah di-release & di-push** (`main` = `origin/main` = tag `v1.2.0`, tree bersih).
Jalur rilis: v1.0.0 (project-ready) → v1.1.0 (Precision visual polish + adoption hardening) → v1.2.0 (Vue input wrappers).
...
- **Pakai di project:** `npm i github:cahyo-dimas/freeday-ui-kit#v1.2.0` — panduan di
