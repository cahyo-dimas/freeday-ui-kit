...
`@cahyo-dimas/freeday/react`. Pola sama dengan contoh Vue — markup yang dirender React di-*enhance* oleh
...
> [`../../docs/getting-started.md`](../../docs/getting-started.md) §React — install dari npm
...
npm install     # menautkan `@cahyo-dimas/freeday` dari root repo (file:../..) + React/Vite
