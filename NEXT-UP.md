...
| 13 | **Bikin kegagalan CI bisa dibaca tanpa hak admin.** Suite browser merah sekali di `b1e1ca3` (docs-only, tetangganya hijau) dan lognya cuma bisa diunduh admin, jadi spec penyebabnya tak pernah diketahui. Bentuknya kecil: `if: failure()` yang mengunggah keluaran TAP sebagai artifact, supaya kejadian berikutnya meninggalkan bukti, bukan cerita | flaky-nya terulang, atau sebelum menambah spec browser lagi |
