/* Foundry — time picker enhancer (optional, zero-dependency).
 ...
 *
 * Icon variants (Foundry convention, same as the date picker): [data-fdy-no-icon]
...
(function () {
  ...
  window.FoundryTimepicker = { init: initTime, initAll: initAll };
})();
