...
[![Release](https://img.shields.io/badge/release-v1.4.1-0078d4?style=flat-square)](https://github.com/cahyo-dimas/freeday-ui-kit/tree/v1.4.1)
...
**Install di CI (`git+https`, bukan `git+ssh`).** `npm i github:...#v1.4.1` menulis
...
"dependencies": {
  "freeday": "git+https://github.com/cahyo-dimas/freeday-ui-kit.git#v1.4.1"
}
```
```yaml
