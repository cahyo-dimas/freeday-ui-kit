...
[![Release](https://img.shields.io/badge/release-v1.2.1-0d9488?style=flat-square)](https://github.com/cahyo-dimas/freeday-ui-kit/tree/v1.2.1)
...
```bash
npm i github:cahyo-dimas/freeday-ui-kit#v1.2.1
```
```js
...
**Install di CI (`git+https`, bukan `git+ssh`).** `npm i github:...#v1.2.1` menulis
...
"dependencies": {
  "freeday": "git+https://github.com/cahyo-dimas/freeday-ui-kit.git#v1.2.1"
}
```
```yaml
